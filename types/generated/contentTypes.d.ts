...
export interface ApiCharacterCharacter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    appearance: Schema.Attribute.Relation<"oneToMany", "api::season.season">;
    better_call_saul_appearance: Schema.Attribute.Relation<
      "oneToMany",
      "api::season.season"
    >;
    ...
    >;
    characterStatus: Schema.Attribute.Enumeration<
      ["Alive", "Presumed dead", "Deceased", "Unknown"]
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<"Alive">;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
...
export interface ApiSeriesItemSeriesItem extends Struct.CollectionTypeSchema {
  collectionName: "series_items";
  info: {
    displayName: "Series";
    pluralName: "series-items";
...
declare module "@strapi/strapi" {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      "api::series-item.series-item": ApiSeriesItemSeriesItem;
